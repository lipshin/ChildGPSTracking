...
public class FragmentLocation extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnLocation = view.findViewById(R.id.childLocationBtn);
        Button btnAdultLocation = view.findViewById(R.id.yourLocationBtn);
        ...
        btnAdultLocation.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_location_to_map);
            }
        });
        return view;
    }
    ...
    public void getData() {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                latitudeField.setText(String.valueOf(value.getLatitude()));
                longitudeField.setText(String.valueOf(value.getLongitude()));
                if (latitudeField.getText() == "unknown" || longitudeField.getText() == "unknown"){
                    addressField.setText("unknown");
                    return;
                }
//                try {
//                    get_full(Double.parseDouble(value.getLongitude()), Double.parseDouble(value.getLatitude()));
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
